    ...
    try:
        ...
        def load_bot_settings():
            return load_json_file(BOT_SETTINGS_FILE, {
                'force_channel': '@MR_VPS1',
                'force_channel2': '@VSA_A',
                'points_per_server': 10,
                'points_per_invite': 2,
                'dev_channel': 'https://t.me/MR_VPS1',
                'dev_user': 'https://t.me/ln_2008',
                'admin_list': [],
                'codes': {},
                'panel_url': ''
            })
        ...
        def dev_channel_btn(message):
            ...
            bot.send_message(message.chat.id, "📢 قناة المطور الرسمية:",
                reply_markup=types.InlineKeyboardMarkup().add(
                    types.InlineKeyboardButton("📢 انضم للقناة", url="https://t.me/MR_VPS1")
                ))
        ...
        def dev_user_btn(message):
            ...
            bot.send_message(message.chat.id, "👨‍💻 مطور البوت:",
                reply_markup=types.InlineKeyboardMarkup().add(
                    types.InlineKeyboardButton("💬 تواصل مع المطور", url="https://t.me/ln_2008")
                ))
        ...
        def buy_points(message):
            ...
            bot.send_message(message.chat.id,
                ...
                parse_mode="Markdown",
                reply_markup=types.InlineKeyboardMarkup().add(
                    types.InlineKeyboardButton("👨‍💻 تواصل مع المطور", url=settings.get('dev_user', 'https://t.me/ln_2008'))
                )
            )
        ...
        def help_msg(message):
            ...
            bot.send_message(message.chat.id,
                ...
                parse_mode="Markdown",
                reply_markup=types.InlineKeyboardMarkup().add(
                    types.InlineKeyboardButton("📢 قناة المطور", url=settings.get('dev_channel', 'https://t.me/MR_VPS1'))
                )
            )
